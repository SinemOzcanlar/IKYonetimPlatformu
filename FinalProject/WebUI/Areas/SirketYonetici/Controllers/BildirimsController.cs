...
namespace WebTestUI.Areas.SirketYonetici.Controllers
{
    ...
    public class BildirimsController : Controller
    {
        ...
        public ActionResult SablonIndex()//Sablon listesi
        {
            ...
            bildirimler = bildirimler.Where(a => a.SablonTanimi != null && a.CalisanId == KullaniciId() && a.SablonVsBildirim == SablonVsBildirim.Sablon);//Yoneticinin oluşturuduğu şablonlar için
