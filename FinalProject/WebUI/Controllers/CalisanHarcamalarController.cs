...
namespace WebTestUI.Controllers
{
    public class CalisanHarcamalarController : Controller
    {
        ...
        private readonly EfCalisanHarcamaDal EfCalisanHarcamaDal;
        ...
        {
            HttpResponseMessage result = CalisanHarcamaFactory.Factory.GetHarcamaById(id, out CalisanHarcama harcama);
